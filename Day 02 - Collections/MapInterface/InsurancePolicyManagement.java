...
public class InsurancePolicyManagement {
    ...
    static class PolicyManager {
        ...
        public List<Policy> getPoliciesExpiringIn30Days() {
            ...
            SortedMap<LocalDate, List<Policy>> upcoming = treeMap.subMap(now, true, limit, true);
    ...
    public static void main(String[] args) {
        ...
        manager.addPolicy(new Policy("P56", "Lucky", LocalDate.now().plusDays(10)));
        manager.addPolicy(new Policy("P98", "Raja", LocalDate.now().plusDays(40)));
        manager.addPolicy(new Policy("P3", "Bhaskar", LocalDate.now().minusDays(5)));
        System.out.println("Get Policy P56:");
        System.out.println(manager.getPolicyByNumber("P56"));
        System.out.println("\nPolicies expiring in 30 days:");
        for (Policy p : manager.getPoliciesExpiringIn30Days()) System.out.println(p);
        System.out.println("\nPolicies for Bhaskar:");
        for (Policy p : manager.getPoliciesByHolder("Bhaskar")) System.out.println(p);
