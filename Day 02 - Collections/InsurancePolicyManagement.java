...
public class InsurancePolicyManagement {
    public static void main(String[] args) {
        ...
        Policy p1 = new Policy("32", "Lucky", LocalDate.now().plusDays(10), "Health", 5000);
        Policy p2 = new Policy("P64", "Kiran", LocalDate.now().plusDays(45), "Auto", 7000);
        Policy p3 = new Policy("P57", "Lingesh", LocalDate.now().plusDays(20), "Home", 6000);
        Policy p4 = new Policy("P63", "Anish", LocalDate.now().plusDays(10), "Health", 5000);
    ...
    public static void performanceTest(Set<Policy> set, String type) {
        ...
        for (int i = 0; i < 10000; i++) {
            set.add(new Policy("PX" + i, "Holder" + i, LocalDate.now().plusDays(i), "Auto", 1000));
        }
        long end = System.nanoTime();
        System.out.println(type + " Add Time: " + (end - start) / 1_000_000.0 + " ms");
    }
}
